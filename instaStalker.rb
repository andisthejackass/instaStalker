...
get "/" do
  ...
  </div></br>This product uses the Instagram API but is not endorsed or certified by Instagram.</br>' + links
end
...
get "/about" do
  ...
  While geolocation is great and fun, some privacy issues may rise without the users\' knowledge. For example, some users (some meaning me and not sure if anyone else...) like to take photos with their phone camera and then when they get home to their precious WiFi upload the pictures to Instagram. If you don\'t add a venue to your photo (which is optional), Instagram will take your current location and put it in the Photo Map. So, if you upload many pictures that way, well someone may take a guess on where you kinda live :) </br></br></br>Feel free to contact me for suggestions, bugs or if you\'re bored at andisthejackassatgmaildotcom</br>Code available @ <a href="https://github.com/andisthejackass/instaStalker">GitHub</a></br>Connect icons by <a href="http://designmoo.com/3535/instagram-sign-in-buttons">Murat Mutlu</a></h2></br><a href="javascript: history.go(-1)">Back to instaStalker</a>'
end
